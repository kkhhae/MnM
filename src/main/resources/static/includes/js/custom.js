...
$(function(){
	...
	var pwmodifyLink = $(".pwmodifyLink");
	var searchLink = $(".searchLink");
	
	var loginct = $( "#login-content" );
	var signupct= $("#signup-content");
	
	var pwmodifyct= $("#pwmodify-content");
	var searchct= $("#search-content");
    ...
    //pop up for search form
    searchLink.on('click', function(event){
    	event.preventDefault();
    	searchct.parents(overlay).addClass("openform");
		$(document).on('click', function(e){
		var target = $(e.target);
		if ($(target).hasClass("overlay")){
				$(target).find(searchct).each( function(){
					$(this).removeClass("openform");
				});
				setTimeout( function(){
					$(target).removeClass("openform");
    ...
    //pop up for pwmodify form
    pwmodifyLink.on('click', function(event){
    	event.preventDefault();
    	pwmodifyct.parents(overlay).addClass("openform");
		$(document).on('click', function(e){
		var target = $(e.target);
		if ($(target).hasClass("overlay")){
				$(target).find(pwmodifyct).each( function(){
					$(this).removeClass("openform");
				});
				setTimeout( function(){
					$(target).removeClass("openform");
